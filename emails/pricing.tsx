            ...
            <Tailwind>
                <Body className="bg-black my-auto mx-auto font-sans px-2 ">
                    <Container className=" mt-[40px] mx-auto pt-[45px] max-w-[465px] text-white">
                        ...
                        <Section className="bg-white rounded-t-3xl my-auto font-sans max-w-[600px] text-black">
                            <Heading
                                as="h2"
                            ...
                            <Text className="text-center px-4 text-[16px]">
                                ¡Gracias por asegurar tu membresía con nosotros!
                                Para agilizar la validación de tu pago, puedes
                                reportarlo directamente enviando tus datos
                                <br /> en este mismo correo:
                            </Text>
