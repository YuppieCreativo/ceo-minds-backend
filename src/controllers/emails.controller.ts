...
`,
  ...
  async sendAttendanceEmailPonenteSorpresa({
    userEmail,
  }: {
    userEmail: string;
  }) {
    const { error } = await resend.emails.send({
      ...
      from: "CEO Minds <info@ceominds.net>",
      cc: ["maykerting@gmail.com", "adri@yuppiecreativo.com"],
      subject: "Asistencia confirmada - “Ponente Sorpresa” 19 de Julio",
      html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html dir="ltr" lang="en">
  <head>
    <link
      rel="preload"
      as="image"
      href="https://yuppie-bucket.s3.us-east-1.amazonaws.com/ceominds/emails/Ponente+Sorpresa+-+Email.png" />
    <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
    <meta name="x-apple-disable-message-reformatting" />
    <!--$-->
  </head>
      ...
      <tbody>
        <tr style="width:100%">
          <td>
            <img
              alt="CEOMinds Attendance"
              src="https://yuppie-bucket.s3.us-east-1.amazonaws.com/ceominds/emails/Ponente+Sorpresa+-+Email.png"
              style="border-radius:0.5rem;object-position:center;max-width:95%;max-height:95%;margin-left:auto;margin-right:auto;display:block;outline:none;border:none;text-decoration:none" />
          </td>
        </tr>
      </tbody>
...
`,
  ...
  async sendAttendanceEmailIsaacFernandez({
    userEmail,
  }: {
    userEmail: string;
  }) {
    const { error } = await resend.emails.send({
      ...
      from: "CEO Minds <info@ceominds.net>",
      cc: ["maykerting@gmail.com", "adri@yuppiecreativo.com"],
      subject: "Asistencia confirmada - “Isaac Fernández” 23 de Agosto",
      html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                    <html dir="ltr" lang="en">
                      <head>
                        <link
                          rel="preload"
                          as="image"
                          href="https://yuppie-bucket.s3.us-east-1.amazonaws.com/ceominds/emails/Isaac+Fern%C3%A1ndez+-+Email.png" />
                        <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
                        <meta name="x-apple-disable-message-reformatting" />
                        <!--$-->
                      </head>
                          ...
                          <tbody>
                            <tr style="width:100%">
                              <td>
                                <img
                                  alt="CEOMinds Attendance"
                                  src="https://yuppie-bucket.s3.us-east-1.amazonaws.com/ceominds/emails/Isaac+Fern%C3%A1ndez+-+Email.png"
                                  style="border-radius:0.5rem;object-position:center;max-width:95%;max-height:95%;margin-left:auto;margin-right:auto;display:block;outline:none;border:none;text-decoration:none" />
                              </td>
                            </tr>
                          </tbody>
  ...
  async CaylinMilianiEmail({ userEmail }: { userEmail: string }) {
    const { error } = await resend.emails.send({
      to: [own_email, userEmail],
      from: "CEO Minds <info@ceominds.net>",
      cc: ["maykerting@gmail.com", "adri@yuppiecreativo.com"],
...
<html dir="ltr" lang="en">
  <head>
    <link
      rel="preload"
      as="image"
      href="https://yuppie-bucket.s3.us-east-1.amazonaws.com/ceominds/emails/caylinMilianiEmail.png" />
    <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
    <meta name="x-apple-disable-message-reformatting" />
    <!--$-->
  </head>
      ...
      <tbody>
        <tr style="width:100%">
          <td>
            <img
              alt="CEOMinds Attendance"
              src="https://yuppie-bucket.s3.us-east-1.amazonaws.com/ceominds/emails/caylinMilianiEmail.png"
              style="border-radius:0.5rem;object-position:center;max-width:95%;max-height:95%;margin-left:auto;margin-right:auto;display:block;outline:none;border:none;text-decoration:none" />
          </td>
        </tr>
      </tbody>
...
`,
  ...
  async AndreinaBarrera({ userEmail }: { userEmail: string }) {
    const { error } = await resend.emails.send({
      to: [own_email, userEmail],
      from: "CEO Minds <info@ceominds.net>",
      cc: ["maykerting@gmail.com", "adri@yuppiecreativo.com"],
            ...
            <html dir="ltr" lang="en">
              <head>
                <link
                  rel="preload"
                  as="image"
                  href="https://yuppie-bucket.s3.us-east-1.amazonaws.com/ceominds/emails/Andreina+Barrera+-+Email.png" />
                <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
                <meta name="x-apple-disable-message-reformatting" />
                <!--$-->
              </head>
              <body style="padding-top:2.5rem;padding-bottom:2.5rem">
                <table
                  ...
                  <tbody>
                    <tr>
                      <td style="padding-top:2.5rem;padding-bottom:2.5rem">
                        <table
                          align="center"
                          width="100%"
                          border="0"
                          ...
                          <tbody>
                            <tr style="width:100%">
                              <td>
                                <img
                                  alt="CEOMinds Attendance"
                                  src="https://yuppie-bucket.s3.us-east-1.amazonaws.com/ceominds/emails/Andreina+Barrera+-+Email.png"
                                  style="border-radius:0.5rem;object-position:center;max-width:95%;max-height:95%;margin-left:auto;margin-right:auto;display:block;outline:none;border:none;text-decoration:none" />
                              </td>
                            </tr>
                          </tbody>
